...
// HouseRegisterForm クラスは新規宿泊施設登録フォームを管理するクラス
// ユーザーが新しい宿泊施設を登録するときに使用
...
public class HouseRegisterForm {
    ...
    @Min(value = 1, message = "宿泊料金は1円以上に設定してください。") // 宿泊料金の最小値を1円に設定
    private Integer price;

    @NotNull(message = "定員を入力してください。") // 定員は必須（null禁止）
    @Min(value = 1, message = "定員は1人以上に設定してください。") // 宿泊人数の最小値を1人に設定
